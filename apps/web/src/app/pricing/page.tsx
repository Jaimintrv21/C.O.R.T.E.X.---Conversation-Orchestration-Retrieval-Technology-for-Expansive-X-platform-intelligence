...
const comparisonRows = [
  ...
  { name: "Artifact Generation", free: true, pro: true, enterprise: true },
  { name: "Full Analytics & Heatmaps", free: true, pro: true, enterprise: true },
  { name: "Knowledge Graph", free: true, pro: true, enterprise: true },
  { name: "Team Workspaces & RBAC", free: false, pro: "Up to 10", enterprise: "Unlimited" },
  { name: "SSO / SAML", free: false, pro: true, enterprise: true },
  { name: "PII Redaction", free: false, pro: true, enterprise: true },
  { name: "Audit Logs", free: false, pro: true, enterprise: true },
  { name: "Cloud Sync & Backups", free: "weekly/daily once per day", pro: "high and good", enterprise: "Unlimited" },
