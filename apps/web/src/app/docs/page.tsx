...
export default function DocsPage() {
  const sections = [
    { title: "Getting Started", icon: BookOpen, desc: "Installation, environment setup, and architecture overview.", link: "#" },
    { title: "Document Skills (docx, pdf, pptx)", icon: FileText, desc: "How to leverage Anthropic's document capabilities for parsing advanced file formats.", link: "#" },
    { title: "API Reference", icon: Code, desc: "FastAPI endpoint definitions and websocket streaming interfaces.", link: "#" },
    { title: "Knowledge Graph", icon: Network, desc: "Entity extraction pipeline and D3 graph visualization concepts.", link: "#" },
    { title: "Vector Indexing", icon: Database, desc: "pgvector configuration, BM25 reranking, and semantic search queries.", link: "#" },
    { title: "AI Providers", icon: Cpu, desc: "Configuration for OpenAI, Anthropic, Gemini, and local Ollama instances.", link: "#" },
  ];
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sections.map((section, idx) => (
            <Link key={idx} href={section.link} className="group p-6 rounded-3xl backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.05] hover:border-white/[0.15] transition-all duration-300">
